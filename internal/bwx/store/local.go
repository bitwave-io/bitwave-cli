// Package store provides bwx's workspace-aware storage implementations.
//
...
// LocalWorkspace reads/writes a bwx workspace as plain-text files.
...
// config.ErrNotAWorkspace if the dir has no .bwx.toml.
...
// synthetic ids assigned. Used by `bwx migrate` to push journals one at a
// time.
