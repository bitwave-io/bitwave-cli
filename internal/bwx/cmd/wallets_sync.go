...
//
//	go build -ldflags "-X github.com/bitwave-io/bitwave-cli/internal/bwx/cmd.defaultBlockchainQueryBaseURL=http://localhost:8080"
//
// `make cli-local` builds a bwx that points at localhost by default.
