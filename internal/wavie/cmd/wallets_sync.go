...
//
//	go build -ldflags "-X github.com/bitwave-io/bitwave-cli/internal/wavie/cmd.defaultBlockchainQueryBaseURL=http://localhost:8080"
//
// `make cli-local` builds a wavie that points at localhost by default.
