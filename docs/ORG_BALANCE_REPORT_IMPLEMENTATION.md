...
An end-to-end report can be run with:
...
The downloaded output includes ticker, value, fiat value, wallet, wallet ID,
wallet address, token details, blockchain, and subsidiary information.
